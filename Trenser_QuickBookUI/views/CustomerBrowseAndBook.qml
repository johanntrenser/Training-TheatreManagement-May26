...
Item {
    ...
    // // Component C: Key-Value Label Line
    ...
    //         showDateAndTime: "2026-08-15 18:30"
    //         ticketPrice: 250.00
    //     }
    //     ListElement {
    //         showId: "SHW-102"
    ...
    //         screenId: "SCR-2"
    //         movieTitle: "Inception"
    //         showDateAndTime: "2026-08-15 21:00"
    //         ticketPrice: 300.00
    //     }
    //     ListElement {
    //         showId: "SHW-201"
    ...
    //         showDateAndTime: "2026-08-16 20:00"
    //         ticketPrice: 280.00
    //     }
    // }

    // // Grid Seat Map representation
    // ListModel {
    //     id: seatGridModel
    ...
    //     ListElement { seatId: "C1"; seatStatus: "AVAILABLE" }
    //     ListElement { seatId: "C2"; seatStatus: "AVAILABLE" }
    //     ListElement { seatId: "C3"; seatStatus: "AVAILABLE" }
    //     ListElement { seatId: "C4"; seatStatus: "AVAILABLE" }
    // }
    ...
    //         showDetailsModel.append({ showId: "SHW-102", movieId: "MOV-001", theatreName: "INOX Leisure", screenId: "SCR-2", movieTitle: "Inception", showDateAndTime: "2026-08-15 21:00", ticketPrice: 300.00 });
    //     } else if (currentMovieId === "MOV-002") {
    ...
    //     } else {
    //         showDetailsModel.append({ showId: "SHW-301", movieId: "MOV-003", theatreName: "PVR Cinemas", screenId: "SCR-1", movieTitle: "The Dark Knight", showDateAndTime: "2026-08-17 19:00", ticketPrice: 220.00 });
    //     }
    ...
    //     for (var loopIndex = 0; loopIndex < tempSeatList.length; loopIndex++) {
    //         if (tempSeatList[loopIndex] === targetSeatId) {
    //             existingIndex = loopIndex;
    //             break;
    //         }
    //     }
    ...
    //             Button {
    //                 text: "< Back to Movies"
    //                 onClicked: customerPage.activeViewStep = "BROWSE_MOVIES"
    //             }
    //             Text {
    //                 text: "Available Shows for: " + customerPage.selectedMovieTitle
    //                 font.pixelSize: 16
    //                 font.bold: true
    //                 anchors.verticalCenter: parent.verticalCenter
    //             }
    ...
    //         // Screen Screen Graphic Representation
    //         Rectangle {
    ...
    //                 color: {
    //                     if (model.seatStatus === "BOOKED" || model.seatStatus === "BLOCKED") {
    //                         return "#E74C3C"; // Red for unavailable
    //                     } else if (isChosen) {
    //                         return "#2ECC71"; // Green for selected
    //                     } else {
    //                         return "#ECF0F1"; // Light Gray for available
    //                     }
    //                 }

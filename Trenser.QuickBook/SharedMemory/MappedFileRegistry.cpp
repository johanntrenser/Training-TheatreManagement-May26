 ...
 * Description: Retrieves the total number of booking records from the mapped file registry.
 * Parameters:
 *    None
 * Returns:
 *    Integer count of booking records
 */
int MappedFileRegistry::getBookingCount() const
{
    return m_bookings->getRecordCount();
}

/*
 * Function: getTheatresCount
 * Description: Retrieves the total number of theatres from the mapped file registry.
 * Parameters:
 *    None
 * Returns:
 *    Integer count of theatres
 */
int MappedFileRegistry::getTheatresCount() const
{
    return m_theatres->getRecordCount();
}

/*
 * Function: getNotificationsCount
 * Description: Retrieves the total number of notifications from the mapped file registry.
 * Parameters:
 *    None
 * Returns:
